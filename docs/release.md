...
```text
src-tauri/target/aarch64-apple-darwin/release/bundle/dmg/fk-trans_0.1.0_aarch64.dmg
...
```sh
RELEASE_TAG=app-v0.1.1 npm run release:mac
```
...
3. Create and push a tag such as `app-v0.1.1`.
